...
Remember that transgressors can only remain transgressors if
their entourage enables it by not saying no to their behaviour.
Therefore, if you have questions on how to handle a conflict about Labitat
or if you are in doubt if something is a violation of the code of conduct policy,
